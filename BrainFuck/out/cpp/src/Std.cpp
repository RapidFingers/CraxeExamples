...
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_26_is,"Std","is",0x3c56d6f5,"Std.is","/home/grabli66/haxe/std/cpp/_std/Std.hx",26,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_30_instance,"Std","instance",0x1431f4e0,"Std.instance","/home/grabli66/haxe/std/cpp/_std/Std.hx",30,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_34_string,"Std","string",0xcf48855c,"Std.string","/home/grabli66/haxe/std/cpp/_std/Std.hx",34,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_38_int,"Std","int",0x8fa53b84,"Std.int","/home/grabli66/haxe/std/cpp/_std/Std.hx",38,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_42_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","/home/grabli66/haxe/std/cpp/_std/Std.hx",42,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_46_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","/home/grabli66/haxe/std/cpp/_std/Std.hx",46,0x40ed336a)
HX_LOCAL_STACK_FRAME(_hx_pos_62453aba675184ad_49_random,"Std","random",0x75a77e8e,"Std.random","/home/grabli66/haxe/std/cpp/_std/Std.hx",49,0x40ed336a)
...
bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_26_is)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,is,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,hx::Class c){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_30_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_34_string)
HXDLIN(  34)		if (hx::IsNull( s )) {
HXDLIN(  34)			return HX_("null",87,9e,0e,49);
            		}
            		else {
HXDLIN(  34)			return ( (::String)(s->toString()) );
            		}
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_38_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_42_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_46_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_62453aba675184ad_49_random)
HXLINE(  50)		if ((x <= 0)) {
HXLINE(  50)			return 0;
            		}
HXLINE(  51)		return  ::__hxcpp_irand(x);
            	}
