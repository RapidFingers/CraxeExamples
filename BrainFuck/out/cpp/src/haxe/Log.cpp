...
HX_LOCAL_STACK_FRAME(_hx_pos_e94e1d4c6e5926d7_30___default_trace,"haxe.Log","__default_trace",0xe2f5e5d5,"haxe.Log.__default_trace","/home/grabli66/haxe/std/cpp/_std/haxe/Log.hx",30,0x3e501b34)
namespace haxe{
...
void _hx_run( ::Dynamic v, ::Dynamic infos){
            	HX_STACKFRAME(&_hx_pos_e94e1d4c6e5926d7_30___default_trace)
...
HXLINE(  37)			__trace(( (::String)(v) ),infos);
            		}
            	}
