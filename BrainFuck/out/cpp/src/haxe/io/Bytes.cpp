...
HX_LOCAL_STACK_FRAME(_hx_pos_464b3142acc6d207_471_alloc,"haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","C:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",471,0x20b05d0c)
namespace haxe{
namespace io{
...
bool Bytes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Bytes_obj::alloc(int length){
            	HX_GC_STACKFRAME(&_hx_pos_464b3142acc6d207_471_alloc)
