...
type 
    ...
    BrainFuckStatic = ref object of RootObj
...
proc get(this:Tape) : int =
    return this.tape.b.get(this.pos)

proc inc(this:Tape, x:int) : void =
    var b = this.tape.b.get(this.pos)
    b += x
    var locthis = this.tape
    var pos = this.pos
    locthis.b.set(pos,  b and 255)
...
proc runInternal(this:Program, operations:HaxeArray[Operation], tape:Tape) : void =
    ...
    while locg < operations.length:        
        ...
        if op == 0:
            ...
            var b = tape.tape.b.get(tape.pos)
            b += v
            ...
            LogStaticInst.trace(tape.tape.b.get(tape.pos), "src/BrainFuck.hx", 79, "Program", "runInternal")
        elif op == 3:
            var v2 = cast[OperationLoop](op).v
            while tape.tape.b.get(tape.pos) > 0:
