...
public class FieldLookup extends haxe.lang.HxObject
{
	...
	public FieldLookup()
	{
		//line 28 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 41 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		int min = 0;
		//line 42 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		int max = length;
		//line 44 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		while (( min < max ))
		{
			//line 46 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
			int mid = ((int) (( (( max + min )) / 2 )) );
			//line 47 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
			int classify = hash.compareTo(hashs[mid]);
			//line 48 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
			if (( classify < 0 )) 
			{
				//line 50 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
				max = mid;
			}
			else
			{
				//line 51 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
				if (( classify > 0 )) 
				{
					//line 52 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
					min = ( mid + 1 );
				}
				else
				{
					//line 54 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
					return mid;
				}
		...
		//line 58 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		return  ~ (min) ;
	}
	...
	{
		//line 62 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 63 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 67 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 68 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = ((double) (0) );
	}
	...
	{
		//line 72 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		java.lang.System.arraycopy(((java.lang.Object) (a) ), ((int) (( pos + 1 )) ), ((java.lang.Object) (a) ), ((int) (pos) ), ((int) (( ( length - pos ) - 1 )) ));
		//line 73 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		a[( length - 1 )] = null;
	}
	...
	{
		//line 121 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 122 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		double[] a1 = a;
		//line 122 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
		int capacity = a1.length;
		//line 122 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
	...
	{
		//line 123 "C:\\Users\\VEgorov\\AppData\\Roaming\\haxe\\versions\\4.0.0-rc.3\\std\\java\\internal\\FieldLookup.hx"
